...
class CustomImageDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            return self.__getitem__((idx + 1) % len(self))  # 다음 이미지로 이동
...
def main():
    ...
    # Load dataset
    train_file = f"C:/Users/honjo/profile_level_prediction/data/5_fold_3n_cleaned_null_maximization/train_fold_1.csv"
    valid_file = f"C:/Users/honjo/profile_level_prediction/data/5_fold_3n_cleaned_null_maximization/valid_fold_1.csv"
    ...
    df['cs_rank'] = df['cs_rank'].map(label2id)
    ...
    print("Dataset split: Train:", len(train_df), ", Validation:", len(val_df), ", Test:", len(test_df))
    ...
    run_dir = (
        f'runs_{args.num_class}class_train_valid_test/{timestamp}_'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--lr_decay', type=float, default=0.9993, help="Learning rate decay")
